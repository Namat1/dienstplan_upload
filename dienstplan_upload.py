        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with ZipFile(zip_path, "w") as zipf:
                ...
                for file in uploaded_files:
                    ...
                    # 1. Alle Fahrer schon mal erfassen – auch ohne Inhalt
                    for _, row in df.iterrows():
                        for pos in [(3, 4), (6, 7)]:
                            ...
                            if nachname or vorname:
                                fahrer_name = f"{nachname}, {vorname}".strip().strip(",")
                                if fahrer_name not in fahrer_dict:
                                    fahrer_dict[fahrer_name] = {}

                    # 2. Inhalt / Touren einlesen
                    for _, row in df.iterrows():
                        datum = row.iloc[14]
                        tour = row.iloc[15]
                        uhrzeit = row.iloc[8]
                        ...
                        tour_str = str(tour).strip() if pd.notna(tour) else "–"
                        ...
                        for pos in [(3, 4), (6, 7)]:
                            ...
                            if nachname or vorname:
                                ...
                                # Nur wenn ein Datum vorhanden ist, dem Tag zuordnen
                    ...
                    # 3. Fallback-Woche bestimmen, falls gar kein Datum existiert
                    ...
                    for fahrer_name, eintraege in fahrer_dict.items():
                        # Falls Fahrer eigene Einträge hat: Woche aus seinen Daten
                        if eintraege:
                            ...
                            # Falls komplett leer: globale Fallback-Woche
